...
def request_persons():
    ...
    past_time = now - datetime.timedelta(minutes=45)
...
if __name__ == "__main__":
    ...
    database = 'C:\\Users\\a.bodnya\\.PyCharmCE2018.1\\config\\scratches\\{}-{}.csv'.format(from_date, to_date)
    ...
    while True:
        ...
        for guid in data2:
            guids.append(guid[0])
        print(guids)
        result = get_photos(guids)["result"]
        for guid in guids:
